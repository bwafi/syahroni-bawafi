...
const Hero = () => {
  return (
    <section className="w-full mt-32">
      <div>
        <p className="text-green font-sfMono mb-8">Hi, my name is</p>
        <h1 className="text-[80px] leading-none text-lightes-slate font-calibre font-semibold">
          Syahroni Bawafi.
        </h1>
        <h2 className="text-[80px] leading-none text-slate font-semibold font-calibre">
