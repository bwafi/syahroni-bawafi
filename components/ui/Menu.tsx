...
const Menu: FC<menuType> = ({ isOpen, setIsOpen }) => {
  return (
    <div
      className={`absolute md:static left-0 top-0 w-full md:w-fit h-screen md:h-fit`}>
      <div className="flex flex-col md:flex-row justify-center absolute md:static right-0 w-8/12 md:w-fit h-screen md:h-fit bg-light-navy md:bg-transparent gap-7 items-center">
